...
#-----------------------------------
csv_filename = 'iot_handLms.csv'
y_targets = ['off','on'] #เรียงชื่อตามตัวอักษร
...
history = model.fit(x_train,y_train_1h,epochs=60,batch_size=8,verbose=1,validation_split=0.2)
...
model.save(iot_handLms_model_filename)
